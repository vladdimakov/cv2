...
void CVFuns::calcAverageDeviationImg(Mat currentFrame, Point2f currentOffset, float refreshRate)
{
	Mat currentDeviationImg, currentDeviationImgStaticPart;
